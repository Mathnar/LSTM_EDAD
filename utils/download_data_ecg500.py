...
def download_and_clean_ecg500():
    ...
    if args.download:
        ...
        # Loading data
        train = pd.read_table(
            '/Users/fernandochirici/Desktop/DataMining/adasa/Recurrent-Autoencoder/data/ECG5000/ECG5000_TRAIN.txt',
            sep=r'\s{2,}', engine='python', header=None)
        test = pd.read_table(
            '/Users/fernandochirici/Desktop/DataMining/adasa/Recurrent-Autoencoder/data/ECG5000/ECG5000_TEST.txt',
            sep=r'\s{2,}', engine='python', header=None)
